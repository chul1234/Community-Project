    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        // SecurityFilterChain : , 웹사이트로 들어오는 모든 방문객(요청)을 검사
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/login", "/register", "/lib/**", "/*.js", "/views/**", "/*.html").permitAll()
            ...
            .formLogin(form -> form
                ...
                .loginProcessingUrl("/login") //사용자가 아이디와 비밀번호를 입력하고 '로그인' 버튼을 눌렀을 때, 그 정보가 전송될 서버의 URL
                // ★★★ 로그인 성공 시 메인 페이지('/')로 이동하도록 수정 ★★★
